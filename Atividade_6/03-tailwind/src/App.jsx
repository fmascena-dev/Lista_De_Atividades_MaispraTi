...
export default function App() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col" style={{backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)'}}>
      <Navbar
      ...
      {showCart ? (
        ...
        <main 
          className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-6 max-w-7xl mx-auto w-full"
          aria-label="Produtos"
        >
